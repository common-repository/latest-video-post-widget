...
Plugin URI: http://codeflavor.com
Description: A widget that shows the latest post that contains video embedded with iframe.
Author: CodeFlavor
Author URI: http://codeflavor.com
Version: 1.0.3
Text Domain: latest-video-post-widget
License: GPL version 2 or later - http://www.gnu.org/licenses/old-licenses/gpl-2.0.html
*/

class codeflavor_latestvideopost extends WP_Widget {

	function codeflavor_latestvideopost() {
	   	$widget_ops = array('classname' => 'codeflavor_widget_latest_video_post', 'description' => __('Shows latest video post.', 'latest-video-post-widget'));
		$this->WP_Widget('codeflavor-latest-video-post', __('Latest Video Post', 'latest-video-post-widget'), $widget_ops);
	}
...
add_action('widgets_init', create_function('', 'return register_widget("codeflavor_latestvideopost");'));
